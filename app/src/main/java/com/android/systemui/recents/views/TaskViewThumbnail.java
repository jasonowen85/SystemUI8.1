...
public class TaskViewThumbnail extends View {
    ...
    public void updateThumbnailMatrix() {
        ...
        if (mBitmapShader != null && mThumbnailData != null) {
            ...
            // Modefy Start 2018/08/27 jingtingy
            //reason :调整缩略图高度
            if(mThumbnailRect.bottom < mTaskViewRect.bottom){
                mThumbnailRect.bottom = mTaskViewRect.bottom;
            }
            //Kotei Modefy End 2018/08/27 jingtingy
