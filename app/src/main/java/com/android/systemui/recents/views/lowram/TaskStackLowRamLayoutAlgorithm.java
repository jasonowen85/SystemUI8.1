...
public class TaskStackLowRamLayoutAlgorithm {
    ...
    public float scrollToPercentageX(int scroll) {
        return (float) scroll / (mTaskRect.width() + mPadding);
    }
    ...
    public int percentageToScrollX(float p) {
        return (int) (p * (mTaskRect.width() + mPadding));
    }
