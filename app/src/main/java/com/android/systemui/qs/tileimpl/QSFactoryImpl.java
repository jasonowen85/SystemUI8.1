...
import com.android.systemui.qs.tiles.EqualLoudnessTile;
...
public class QSFactoryImpl implements QSFactory {
    ...
    public QSTile createTile(String tileSpec) {
		...
		//---- start added by sxf 下拉菜单快捷设置面板新增关屏、静音、等响度设置键 -------
		else if (tileSpec.equals("screenoff")) return new ScreenOffTile(mHost);
		else if (tileSpec.equals("mute")) return new MuteTile(mHost);
		else if (tileSpec.equals("equalloudness")) return new EqualLoudnessTile(mHost);
		//---- end added by sxf  ---------------------------------------------------------
