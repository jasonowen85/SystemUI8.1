...
public class QSTileBaseView extends com.android.systemui.plugins.qs.QSTileView {
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
		...
		//---------- start modified by sxf为下拉菜单快捷设置按键添加背景，并修改按键间距 -------
        int size_w = context.getResources().getDimensionPixelSize(R.dimen.qs_quick_tile_size_w);
        int size_h = context.getResources().getDimensionPixelSize(R.dimen.qs_quick_tile_size_h);
		Drawable tileBgDrawable = context.getResources().getDrawable(R.mipmap.home_pulldown_btnbg_n);
        mIconFrame.setBackground(tileBgDrawable);
        addView(mIconFrame, new LayoutParams(size_w, size_h));
        mIcon = icon;
