...
public class StorageNotification extends SystemUI {
    ...
    public static final String ACTION_USB_STORAGE_DEV_MOUNTED = "android.intent.action.USB_STORAGE_DEV_MOUNTED";
    public static final String ACTION_USB_STORAGE_DEV_EJECTING = "android.intent.action.USB_STORAGE_DEV_EJECTING";
    ...
    private void onPublicVolumeStateChangedInternal(VolumeInfo vol) {
        ...
        switch (vol.getState()) {
            ...
            case VolumeInfo.STATE_MOUNTED_READ_ONLY:
                sendUsbState(vol,VolumeInfo.STATE_MOUNTED);
            ...
            case VolumeInfo.STATE_EJECTING:
                sendUsbState(vol,VolumeInfo.STATE_EJECTING);
    ...
    private void sendUsbState(VolumeInfo volumeInfo,int state){
        DiskInfo diskInfo = volumeInfo.getDisk();
        if(null != diskInfo && diskInfo.isUsb()){
            Intent intent = new Intent();
            if(state == VolumeInfo.STATE_MOUNTED){
                intent.setAction(ACTION_USB_STORAGE_DEV_MOUNTED);
            }else if(state == VolumeInfo.STATE_EJECTING){
                intent.setAction(ACTION_USB_STORAGE_DEV_EJECTING);
            }
