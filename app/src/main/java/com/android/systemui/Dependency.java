...
//import com.android.systemui.statusbar.aircon.AirConBarWindowManager;
//import com.android.systemui.statusbar.aircon.AirConController;
//import com.android.systemui.statusbar.aircon.AirConControllerImpl;
...
import com.android.systemui.statusbar.policy.EqualLoudnessControllerImpl;
...
import com.android.systemui.statusbar.policy.MuteController;
import com.android.systemui.statusbar.policy.MuteControllerImpl;
...
import com.android.systemui.statusbar.policy.VolumeControllerImpl;
import com.android.systemui.statusbar.policy.BrightnessController;
import com.android.systemui.statusbar.policy.BrightnessControllerImpl;
...
public class Dependency extends SystemUI {
    ...
    public void start() {
		...
		//------- start added by jack  ----------------
		mProviders.put(MuteController.class, () ->
                new MuteControllerImpl(mContext));
				
	    mProviders.put(EqualLoudnessController.class, () ->
                new EqualLoudnessControllerImpl(mContext));
				
		mProviders.put(VolumeController.class, () ->
                new VolumeControllerImpl(mContext));

        mProviders.put(BrightnessController.class, () ->
                new BrightnessControllerImpl(mContext));
				
	    mProviders.put(ScreenOffController.class, () ->
                new ScreenOffControllerImpl(mContext));	
//	    mProviders.put(NforBtController.class, () ->
//                new NforBtControllerImpl(mContext));
		//------- end added by jack  --------------------------------------------------
        ...
        //mProviders.put(AirConBarWindowManager.class, () ->
                //new AirConBarWindowManager(mContext));
        ...
        //mProviders.put(AirConController.class, () -> new AirConControllerImpl(mContext));
