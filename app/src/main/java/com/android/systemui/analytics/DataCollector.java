...
public class DataCollector implements SensorEventListener {
    ...
    public Uri reportRejectedTouch() {
        ...
        currentSession.setType(Session.Type.REJECTED_TOUCH_REPORT);
        currentSession.end(System.currentTimeMillis(), Session.Result.SUCCESS);
    ...
    private void queueSession(final SensorLoggerSession currentSession) {
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (currentSession.getResult() != Session.Result.SUCCESS) {
    ...
    private void enforceTimeout() {
        if (mTimeoutActive) {
            if (System.currentTimeMillis() - mCurrentSession.getStartTimestampMillis()
                    > TIMEOUT_MILLIS) {
                onSessionEnd(Session.Result.UNKNOWN);
                if (DEBUG) {
    ...
    public void onScreenTurningOn() {
        if (sessionEntrypoint()) {
            ...
            addEvent(PhoneEvent.Type.ON_SCREEN_ON);
        }
    }
    ...
    public void onScreenOnFromTouch() {
        if (sessionEntrypoint()) {
            ...
            addEvent(PhoneEvent.Type.ON_SCREEN_ON_FROM_TOUCH);
        }
    }
    ...
    public void onScreenOff() {
        ...
        addEvent(PhoneEvent.Type.ON_SCREEN_OFF);
        sessionExitpoint(Session.Result.FAILURE);
    }
    ...
    public void onSucccessfulUnlock() {
        ...
        addEvent(PhoneEvent.Type.ON_SUCCESSFUL_UNLOCK);
        sessionExitpoint(Session.Result.SUCCESS);
    }
    ...
    public void onBouncerShown() {
        ...
        addEvent(PhoneEvent.Type.ON_BOUNCER_SHOWN);
    }
    ...
    public void onBouncerHidden() {
        ...
        addEvent(PhoneEvent.Type.ON_BOUNCER_HIDDEN);
    }
    ...
    public void onQsDown() {
        ...
        addEvent(PhoneEvent.Type.ON_QS_DOWN);
    }
    ...
    public void setQsExpanded(boolean expanded) {
        ...
        if (expanded) {
            addEvent(PhoneEvent.Type.SET_QS_EXPANDED_TRUE);
        } else {
            addEvent(PhoneEvent.Type.SET_QS_EXPANDED_FALSE);
        }
    }
    ...
    public void onTrackingStarted() {
        ...
        addEvent(PhoneEvent.Type.ON_TRACKING_STARTED);
    }
    ...
    public void onTrackingStopped() {
        if (mTrackingStarted) {
            ...
            mTrackingStarted = false;
            addEvent(PhoneEvent.Type.ON_TRACKING_STOPPED);
        }
    }
    ...
    public void onNotificationActive() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_ACTIVE);
    }
    ...
    public void onNotificationDoubleTap() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_DOUBLE_TAP);
    }
    ...
    public void setNotificationExpanded() {
        ...
        addEvent(PhoneEvent.Type.SET_NOTIFICATION_EXPANDED);
    }
    ...
    public void onNotificatonStartDraggingDown() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_START_DRAGGING_DOWN);
    }
    ...
    public void onNotificatonStopDraggingDown() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_STOP_DRAGGING_DOWN);
    }
    ...
    public void onNotificationDismissed() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_DISMISSED);
    }
    ...
    public void onNotificatonStartDismissing() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_START_DISMISSING);
    }
    ...
    public void onNotificatonStopDismissing() {
        ...
        addEvent(PhoneEvent.Type.ON_NOTIFICATION_STOP_DISMISSING);
    }
    ...
    public void onCameraOn() {
        ...
        addEvent(PhoneEvent.Type.ON_CAMERA_ON);
    }
    ...
    public void onLeftAffordanceOn() {
        ...
        addEvent(PhoneEvent.Type.ON_LEFT_AFFORDANCE_ON);
    }
    ...
    public void onAffordanceSwipingStarted(boolean rightCorner) {
        ...
        mCornerSwiping = true;
        if (rightCorner) {
            addEvent(PhoneEvent.Type.ON_RIGHT_AFFORDANCE_SWIPING_STARTED);
        } else {
            addEvent(PhoneEvent.Type.ON_LEFT_AFFORDANCE_SWIPING_STARTED);
        }
    }
    ...
    public void onAffordanceSwipingAborted() {
        if (mCornerSwiping) {
            ...
            mCornerSwiping = false;
            addEvent(PhoneEvent.Type.ON_AFFORDANCE_SWIPING_ABORTED);
        }
    }
    ...
    public void onUnlockHintStarted() {
        ...
        addEvent(PhoneEvent.Type.ON_UNLOCK_HINT_STARTED);
    }
    ...
    public void onCameraHintStarted() {
        ...
        addEvent(PhoneEvent.Type.ON_CAMERA_HINT_STARTED);
    }
    ...
    public void onLeftAffordanceHintStarted() {
        ...
        addEvent(PhoneEvent.Type.ON_LEFT_AFFORDANCE_HINT_STARTED);
    }
