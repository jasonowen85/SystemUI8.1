...
public class VolumeUI extends SystemUI {
    ...
    public void start() {
		...
		Log.i(TAG, "sxf Registering default volume sxf  mEnabled ="+mEnabled);
        if (!mEnabled) return;
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.i(TAG, "sxf onConfigurationChanged: sxf mEnabled = "+mEnabled);
        if (!mEnabled) return;
    ...
    private void setDefaultVolumeController() {
        ...
        if (LOGD) Log.d(TAG, "sxf Registering default volume controller");
