...
public class SignalClusterView extends LinearLayout implements NetworkControllerImpl.SignalCallback,
    ...
    private static final String SLOT_ETHERNET = "ethernet";//以太网络
    ...
    private final float mIconScaleFactor;//每个状态栏图标的缩放量。 值为1表示不进行缩放。
    ...
    View mWifiAirplaneSpacer;//Spacer 间隔
