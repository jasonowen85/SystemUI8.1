...
public class Clock extends TextView implements DemoMode, Tunable, CommandQueue.Callbacks,
    ...
    private final CharSequence getSmallTime() {
        ...
        if (!format.equals(mClockFormatString)) {
            ...
            if (mAmPmStyle != AM_PM_STYLE_NORMAL) {
                ...
                if (a > 0) {
                    ...
                    /*
                     * modified by sxf
                     * 因系统默认中文环境下，上午/下午显示在时间前面，其他语言环境中am/pm显示在时间后面
                     * 根据需求设计，在中文环境中显示格式为：hh:mm am/pm ，因此将占位字符'a'移到时间之后，
                     * 并使用"am/pm"替换"上午/下午"
                     */
                    format = format.substring(1) + MAGIC1 + " a" + MAGIC2;
                }
            }
        ...
        String result = sdf.format(mCalendar.getTime()).replace(context.getString(R.string.forenoon),"AM").replace(context.getString(R.string.afternoon),"PM");
